...
export default function Basicidea () {
return (
    <>
...
<div className='sm:hidden flex flex-col items-center mt-10 mx-auto text-center'>
  <img className='w-32 h-32' src='/images/gif3.gif' alt='Design Learning' />
  <h1 className='text-[#F5F5F5] text-lg sm:w-48 w-[95%] font-semibold mt-4'>
    Anyone motivated to dive into the world of learning and exploring design
  </h1>
  <img className='w-20 h-2 my-12 rotate-90' src='/images/Vector 20.png' alt='Divider' />
  <div className='mt-4'>
    <img className='w-16 h-16 mx-auto' src='/images/Group 50.png' alt='Design Group' />
    <div className='mt-2'>
      <img className='w-4 h-16 mx-auto' src='/images/Vector 22.png' alt='Design Vector' />
      <img className='mt-4 w-20 h-4 mx-auto' src='/images/Frame 33605.png' alt='Design Frame' />
      <h1 className='text-[#F5F5F5] text-lg sm:w-48 w-[95%] font-semibold mt-4'>
        Product & UI/UX Design learning and competing community space
      </h1>
    </div>
  </div>
  <img className='w-20 h-2 my-12 rotate-90' src='/images/Vector 20.png' alt='Divider' />
  <div className='mt-4'>
    <img className='w-32 h-32 mx-auto' src='/images/gif2.gif' alt='Job Opportunities' />
    <div className='mt-2'>
      <img className='w-4 h-16 mx-auto' src='/images/Vector 22.png' alt='Design Vector' />
      <img className='mt-4 w-20 h-4 mx-auto' src='/images/Frame 33606.png' alt='Design Frame' />
      <h1 className='text-[#F5F5F5] text-lg sm:w-48 w-[95%] font-semibold mt-4'>
        Enter into a world of immense industry-level Job & Internship Opportunities
      </h1>
    </div>
  </div>
</div>
