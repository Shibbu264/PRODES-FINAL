    ...
    <div>
     ...
     <div className='block mx-auto '>
      <div className='mt-24 text-center sm:text-[48px] font-semibold leading-[66.96px] text-3xl text-[#F5F5F5]'>
        ...
        <p1 className="pt-12 mb-0">A new way of exploring design - one that is focused upon helping you build a network and build a creative foundation to boost your career
          Design Network!</p1></div>
          <div className='flex justify-evenly items-center gap-36'>
          <img className='block w-[256px] h-[256px] mb-44 ml-32' src='/images/Saly-43.png'/>
          <h1 className='  sm:text-[17.565px] leading-[25.733px] w-[404px] h-[51px] text-center  text-[#F5F5F5] border-[#F5F5F5] sm:block mx-auto py-4 sm:px-5 text-lg rounded-3xl border-x-2 border-y-2'> R E D E S I G N <span className='mx-3'>  Y O U R S E L F </span></h1>
          <img className='block mx-auto w-[256px] h-[256px] mb-48  mr-32 ' src='/images/image 116.png'/></div>
