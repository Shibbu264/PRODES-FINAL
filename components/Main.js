...
<Card/>
<div className='w-[85%] justify-center sm:gap-0 sm:flex block mx-auto '>
  <div>
<img className='sm:flex hidden w-[629.144px]
h-[550px]
flex-shrink: 0 ' src='/images/HowWeWorkIllustration.png'/></div>
<div className=''>
<img className='flex w-84 mt-24 h-16'  src='/images/Group 7089.svg'/>
<div className="w-[486px] mt-12 h-[84.05px] text-white text-[31.41px] font-bold font-['Montserrat'] leading-[41.88px] tracking-wide">The exclusive marketplace for everything Design</div>
